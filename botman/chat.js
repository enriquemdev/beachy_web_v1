    ...
    function (t, e, n) {
        ...
        function o(t, e) {
            ...
            for (
                e &&
                null != e.children &&
                (k.length || k.push(e.children), delete e.children);
                k.length;
        ...
        function d(t, e, n, r, o) {
            if (("className" === e && (e = "class"), "key" === e));
                ...
                if ("style" === e) {
                    ...
                    h(t, e, null == r ? "" : r),
                        (null != r && !1 !== r) || t.removeAttribute(e);
                else {
        ...
        function v(t, e, n, r, o, i) {
            L++ ||
                ((q = null != o && void 0 !== o.ownerSVGElement),
        ...
        function b(t, e, n, r, o) {
                ...
                return (
                    t && void 0 !== t.splitText && t.parentNode && (!t._component || o)
                        ...
                        : ((i = document.createTextNode(e)),
                            t && (t.parentNode && t.parentNode.replaceChild(i, t), _(t, !0))),
                    (i.__preactattr_ = !0),
                    i
                );
            var s = e.nodeName;
            ...
            return (
                !I &&
                    ...
                    : ((f && f.length) || null != c) &&
                    g(i, f, n, r, I || null != p.dangerouslySetInnerHTML),
                w(i, e.attributes, p),
                (q = a),
                i
            );
        ...
        function g(t, e, n, r, o) {
            ...
            if (0 !== v)
                for (var w = 0; v > w; w++) {
                    ...
                    null != T
                        ? (m++, (h[T] = O))
                        : (C || (void 0 !== O.splitText ? !o || O.nodeValue.trim() : o)) &&
                        (d[g++] = O);
                }
            if (0 !== x)
                for (var w = 0; x > w; w++) {
        ...
        function C(t, e, n) {
            ...
            if (
                (t.prototype && t.prototype.render
                    ? ((r = new t(e, n)), A.call(r, e, n))
                    : ((r = new A(e, n)), (r.constructor = t), (r.render = T)),
                    o)
            )
        ...
        function j(t, e, n, r, o) {
            t._disable ||
                ((t._disable = !0),
                    ...
                    (t._disable = !1),
                    0 !== n &&
                    (1 !== n && !1 === E.syncComponentUpdates && t.base
                        ? a(t)
                        : M(t, 1, o)),
                    t.__ref && t.__ref(t));
        }
        function M(t, e, n, r) {
            if (!t._disable) {
                ...
                if (
                    (m &&
                        ((t.props = f),
                            ...
                            2 !== e &&
                                ...
                                !1 === t.shouldComponentUpdate(c, u, l)
                                ? (w = !0)
                                : t.componentWillUpdate && t.componentWillUpdate(c, u, l),
                            (t.props = c),
                            (t.state = u),
                            (t.context = l)),
                    ...
                    (o = t.render(c, u, l)),
                        t.getChildContext && (l = i(i({}, l), t.getChildContext()));
                    var O,
                        T,
                        N = o && o.nodeName;
                    if ("function" == typeof N) {
                        var A = p(o);
                        (a = x),
                            a && a.constructor === N && A.key == a.__key
                                ? j(a, A, 1, l, !1)
                                : ((O = a),
                                    (t._component = a = C(N, A, l)),
                        ...
                        (s = g),
                            ...
                            (g || 1 === e) &&
                            (s && (s._component = null),
                                (T = v(s, o, l, n || !m, g && g.parentNode, !0)));
                    if (g && T !== g && a !== x) {
                        var P = g.parentNode;
                        P &&
                            T !== P &&
                            (P.replaceChild(T, g), O || ((g._component = null), _(g, !1)));
                    }
                ...
                if (
                    (!m || n
                        ? R.unshift(t)
                        : w ||
                        (t.componentDidUpdate && t.componentDidUpdate(f, d, h),
        ...
        function S(t) {
            ...
            n
                ? S(n)
                : e &&
                (e.__preactattr_ && e.__preactattr_.ref && e.__preactattr_.ref(null),
                    (t.nextBase = e),
                    f(e),
                    O(t),
                    x(e)),
        ...
        t.exports = function (t) {
            return new Promise(function (e, p) {
                ...
                if (
                    ...
                    f.Authorization =
                        "Basic " +
                        u((t.auth.username || "") + ":" + (t.auth.password || ""));
                }
                if (
                    (d.open(
        ...
        e.a = (function (t) {
            ...
            return (
                ...
                (e.prototype.componentDidMount = function () {
                    ...
                    setTimeout(function () {
                        (t.state.visible = !0),
                            (t.state.visibilityChanged = !0),
                            t.onVisibilityChange(),
                            t.props.onVisibilityChange(t.props.message, t.state);
    ...
    function (t, e, n) {
        ...
        function r() {
            ...
            (t.id = "botmanChatRoot"),
                ...
                Object(a.c)(Object(a.b)(s.a, { userId: o(), conf: c }), t);
        }
        function o() {
            return c.userId || i();
        }
                ...
                return (
                    ...
                    (r.writeToMessages = function (t) {
                        void 0 === t.time && (t.time = new Date().toJSON()),
                            ...
                            t.additionalParameters.replyType &&
                            r.setState({ replyType: t.additionalParameters.replyType });
                    }),
                    (r.botman = i.a),
                            ...
                            ? Object(r.b)(
                                ...
                                Object(r.b)(
                                    "svg",
                                    {
                                        ...
                                        style:
                                            "cursor: pointer; position: absolute; width: 25px; bottom: 19px; right: 16px; z-index: 1000",
                        ...
                        Object(r.b)(
                            ...
                            "AboutIcon" === this.props.conf.aboutText
                                ? Object(r.b)(
                                    ...
                                    {
                                        style:
                                            "position: absolute; width: 14px; bottom: 6px; right: 6px;",
                                        fill: "#EEEEEE",
                                        xmlns: "http://www.w3.org/2000/svg",
            ...
            function e() {
                ...
                return (
                    ...
                    (e.messageVisibilityChange = function (t, n) {
                        ...
                        r.id === t.id &&
                            r.visible !== n.visible &&
                            ((r.visible = n.visible), (r.timeout = 0), e.forceUpdate());
                    }),
                    e
                );
            }
            return (
                ...
                (e.prototype.render = function (t) {
                    var e = new Date(),
                        ...
                        p = c.conf,
                        f = "";
                    (!1 !== n.visible && !1 !== n.visibilityChanged) ||
                        (f += "display:none");
                    ...
                    return Object(r.b)(
                        ...
                        Object(r.b)(
                            ...
                            t.conf.displayMessageTime
                                ? Object(r.b)(
                                    "div",
                                    { class: "time" },
                                    864e5 > e.getMilliseconds() - a.getMilliseconds()
                                        ? o(a, t.conf.timeFormat)
                                        : o(a, t.conf.dateTimeFormat)
                                )
                                : ""
                        )
                    );
                    ...
                    var d = p ? "getUTC" : "get",
                        ...
                        T = {
                            ...
                            Z: l
                                ...
                                : p
                                    ? "UTC"
                                    : ((r + "").match(e) || [""]).pop().replace(n, ""),
                            o:
                                (w > 0 ? "-" : "+") +
                                o(100 * Math.floor(Math.abs(w) / 60) + (Math.abs(w) % 60), 4),
                            S: ["th", "st", "nd", "rd"][
            ...
            return (
                ...
                (e.prototype.render = function (t) {
                    ...
                    return Object(r.b)(
                        ...
                        n && "image" === n.type
                            ? Object(r.b)("img", { src: n.url, style: "max-width: 100%;" })
                            : "",
                        n && "audio" === n.type
                            ? Object(r.b)(
                                "audio",
            ...
            return (
                ...
                (e.prototype.render = function (t) {
                    ...
                    return Object(r.b)(
                        "div",
                        null,
                        n.text && Object(r.b)("div", null, n.text),
            ...
            function e() {
                ...
                return (
                    (e.onVisibilityChange = function () {
                        setTimeout(function () {
                            (e.state.visible = !1),
                                e.props.onVisibilityChange(e.props.message, e.state);
                    ...
                    var e = this,
                        ...
                        i = n.elements.map(function (t) {
                            ...
                            return Object(r.b)(
                                ...
                                Object(r.b)("img", { src: t.image_url }),
                                Object(r.b)("p", null, t.title),
                                Object(r.b)("p", null, t.subtitle),
                                n
                            );
                        });
                    return Object(r.b)(
            ...
            return (
                ...
                (e.prototype.render = function (t) {
                    ...
                    return Object(r.b)(
                        ...
                        null,
                        n.text,
                        this.state.attachmentsVisible ? o : ""
                    );
                }),
                (e.prototype.performAction = function (t) {
                    var e = this;
