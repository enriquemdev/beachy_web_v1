...
<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AÑADIR FAMILIAR EMPLEADO/PERSONA
				</h3>
                            ...
                            <div class="col-12 col-md-6">
								...
								<div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[1-9a-zA-ZáéíóúÁÉÍÓÚ ]{3,50}" class="form-control" name="familiar_de_reg" id="familiar_de" maxlength="50" required="">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 col-md-6">
									<label for="tutor" class="bmd-label-floating">¿ES TUTOR DEL EMPLEADO/PACIENTE? <span class="Obligar">*</span></label>
										<select class="form-control" name="tutor_reg" id="tutor">
                                            <option value="" selected="" disabled=""></option>
