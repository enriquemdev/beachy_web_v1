...
<div class="full-box page-header">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="<?php echo SERVERURL; ?>historial-de-solicitud-cargo-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE SOLICITUDES</a>
					</li>
					<li>
			...
			<?php 
					...
					echo $ins_cargo->paginador_solicitudescargos_controlador($pagina[1],15,$_SESSION['privilegio_spm'],$_SESSION['id_spm'],$pagina[0],"");
