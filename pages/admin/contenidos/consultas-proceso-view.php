...
<div class="full-box page-header">
            ...
            <div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a href="<?php echo SERVERURL; ?>solicitud-consultadr-list/"><i class="fa-solid fa-circle-left"></i> &nbsp; Volver</a>
					</li>
				</ul>	
			</div>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ-0-9- ]{1,60}" class="form-control inputauto" name="nombre" id="nombre_reg" maxlength="30" required="" value="<?php echo $datos['Nombres'] ?> <?php echo $datos['Apellidos'] ?> - <?php echo $datos['CodPaciente'] ?> - <?php echo $datos['Cedula'] ?>  " readonly> <!-- Se agregó cedula y codigo -->
								...
								<div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="notas_consulta" class="bmd-label-floating">NOTAS DE CONSULTA <span class="Obligar">*</span></label>
										<textarea type="text" class="textarea1" name="notas_consulta_reg" id="notas_consulta" maxlength="250"required="" ></textarea>
                                    </div>
                                </div>
							</div>
						</div>
