	...
	<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR RECETA MEDICA
				</h3>
				<p class="text-justify">
					Buscador de receta medica
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="<?php echo SERVERURL; ?>receta-medica-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR RECETA MEDICA</a>
					</li>
				</ul>	
			</div>
<!--1 -->	<?php 
				if(!isset($_SESSION['busqueda_receta-medica']) && empty($_SESSION['busqueda_receta-medica']) ){//se le pone buqueda_ y luego el nombre del modulo
			...
			<div class="container-fluid">
				...
				<form class="form-neon FormularioAjax" action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" method="POST" data-form= "default" autocomplete="off">
					<input type="hidden" name="modulo" value="receta-medica"><!-- input hidden para las busquedas -->
...
<!--2 -->	<?php 
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								...
								<p class="text-center" style="font-size: 20px;">
									Resultados de la búsqueda: <strong> <?php echo($_SESSION['busqueda_receta-medica']); ?> </strong>
								</p><!-- ti -->
			...
			<div class="container-fluid">
				<?php 
					...
					echo $ins_receta->paginador_receta_controlador($pagina[1],15,$_SESSION['privilegio_spm'],$_SESSION['id_spm'],$pagina[0],$_SESSION['busqueda_receta-medica']);
				?>
			</div>
