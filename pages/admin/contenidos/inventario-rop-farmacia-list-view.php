...
<div class="full-box page-header">
	<h3 class="text-left">
		<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; ROP
	</h3>
	<p class="text-justify">
		Se presenta el punto de reorden para cada producto
	</p>
</div>
...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		...
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>inventario-rop-farmacia-list/"><i class="fa-solid fa-square-root-variable"></i> &nbsp; ROP</a>
		</li>
		<li>
...
<div class="container-fluid">
	...
	echo $ins_inventario_farmacia->paginador_inventario_rop_farmacia_controlador($pagina[1], 15, $_SESSION['privilegio_spm'], $_SESSION['id_spm'], $pagina[0], "");
