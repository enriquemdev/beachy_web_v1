...
<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CONSULTAS
				</h3>
				<p class="text-justify">
					Lista de Consultas terminadas
				</p>
			</div>
			...
			<div class="container-fluid">
				...
				<?php if ($_SESSION['cargo_spm'] == 2){ //Aquí tocó luis, agregó acceso a lista nueva para tomar signos vitales?>
                    ...
                    <li>
						<a class="active" href="<?php echo SERVERURL; ?>consulta-list/"><i class="fa-solid fa-list-check"></i> &nbsp; LISTA DE CONSULTAS TERMINADAS</a>
					</li>
			...
			<?php 
					...
					echo $ins_consulta->paginador_consulta_realizada_controlador($pagina[1],15,$_SESSION['privilegio_spm'],$_SESSION['id_spm'],$pagina[0],"", "");
