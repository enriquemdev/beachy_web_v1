...
<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ESPECIALISTAS
				</h3>
				<p class="text-justify">
					Lista de todos los especialistas
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="<?php echo SERVERURL; ?>especialidad-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ESPECIALISTAS</a>
					</li>
			...
			<?php 
					...
					echo $ins_especialidad->paginador_especialidad_controlador($pagina[1],15,$_SESSION['privilegio_spm'],$_SESSION['id_spm'],$pagina[0],"");
