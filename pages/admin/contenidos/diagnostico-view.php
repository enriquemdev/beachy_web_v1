...
<div class="full-box page-header">
			...
			<?php 
				...
				if($datos_item->rowCount()==1){
					...
					?>
			<div class="container-fluid">
			<form class="form-neon FormularioAjax" action="<?php echo SERVERURL;?>ajax/diagnosticoAjax.php" method="POST" data-form= "save" autocomplete="off">
					<fieldset>
						...
						<div class="container-fluid">
							...
							<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<label for="codigo_consulta_reg" class="bmd-label-floating">CONSULTA (POR PACIENTE) <span class="Obligar">*</span></label>
										<div class="autocompletar"><!-- tiii pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,60}"-->
										<input type="text" class="form-control inputauto" name="codigo_consulta_reg" id="codigo_consulta_reg" required=""></div>
