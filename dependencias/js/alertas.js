...
function enviar_formulario_ajax(e){
	...
	var elementosInvalidos = document.querySelectorAll(":invalid");
	var invalidFlag = false;
	for (var elem of elementosInvalidos)
	{
		if (elem.classList.contains("was-validated")){
			invalidFlag = true;
		}
	}

	//document.querySelectorAll(':invalid').length == 0
	if(invalidFlag == false)//Aqui se revisa que ningun campo haya sido rellenado de manera invalida
	{
